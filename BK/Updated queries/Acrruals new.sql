...
FROM
    bls_bill_items      bbi
       ...
       JOIN inv_order_information ioi ON bbi.source_id = ioi.order_id
        ...
        JOIN inv_fiscal_details ifd ON ifd.actor_external_id = ba.external_id and ifd.actor_type IN ('PARTNER','CONSOLIDATED_PARTNER')
WHERE
date(bbi.creation_time) BETWEEN '2025-04-28' AND '2025-05-01'
...
-- AND ba.external_id = 1083
-- AND bbi.source_id in (101304631325)
AND bb.status IN ('OPEN','PROCESSING')
